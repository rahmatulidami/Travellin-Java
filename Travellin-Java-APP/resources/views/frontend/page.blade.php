...
<head>
    ...
    <meta name="dicoding:email" content="rahmatul_i@mhs.usk.ac.id">
...
<body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link text-white" aria-current="page" href="{{ route('landing') }}#footer">Tentang
                            Kami</a></li>
    ...
    <!-- Product section-->
    <section id="products" class="pt-5 container px-4 px-lg-5">
        <p href="#" class="text-center h2 mt-2 fw-bolder font-monospace text-danger">
            <span class="text-black text-capitalize fw-bolder font-monospace">Katalog</span>
        </p>
        <div class="d-flex justify-content-between">
            <a class="btn btn-primary d-flex justify-content-start" href="{{ route('landing.find') }}">Cari Produk<i
                    class="bi bi-search ps-2"></i></a>
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" id="navbarDropdown" href="#" role="button"
        ...
        <div class="row text-center product py-3 pt-5" data-aos="fade-up" data-aos-offset="250" data-aos-duration="900">
            @forelse ($Travels as $travel)
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="card">
                        <img src="{{ Storage::url($travel->image1) }}" class="card-img-top" alt="{{ $travel->name }}">
                        <div class="card-body">
